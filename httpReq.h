...
private:
    ...
    bool range_4_2(state_t & state);
    bool func_4_3(state_t & state);
    bool _func_4_3();
    bool text_4_4(state_t & state);
    bool range_4_5(state_t & state);
    bool text_4_6(state_t & state);
    bool range_4_7(state_t & state);
    bool text_4_8(state_t & state);
    bool text_4_9(state_t & state);
    bool ret_4_10(state_t & state);
    bool loop_6_0(state_t & state);
    bool label_6_0(state_t & state);
    ...
    bool _func_7_3();
    bool text_7_4(state_t & state);
    bool text_7_5(state_t & state);
    ...
    bool range_10_1(state_t & state);
    bool text_10_2(state_t & state);
    bool text_10_3(state_t & state);
